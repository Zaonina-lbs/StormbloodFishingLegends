...
|------|------|
| `/查看背包` | 查看鱼饵库存 |
| `/查看鱼塘 [鱼的种类\|鱼名] [页码]` | 查看钓获的鱼，可按鱼王/鱼皇/普通鱼或鱼名筛选 |
| `/锁定 [id]` | 锁定鱼，防止误售 |
| `/解锁 [id]` | 解锁鱼 |
...
| `/全部出售` | 出售所有未锁定的鱼 |
| `/强制出售 [保留\|仅留唯一\|无保留]` | 强制出售（无视锁定）。保留：保留鱼饵鱼+每种留最大；仅留唯一：每种留最大；无保留：全卖 |
| `/商城` | 查看可购买的鱼饵 |
| `/购买道具 [id] [数量]` | 购买鱼饵 |
| `/氪金 [数量]` | 添加金币 |
| `/查看账单` | 查看氪金记录 |
...
| 指令 | 说明 |
|------|------|
| `/鱼群图鉴` | 查看鱼类收集图鉴（无参数显示全部） |
| `/鱼群图鉴 [鱼名]` | 按鱼名精确查询（如：`/鱼群图鉴 红龙`） |
| `/鱼群图鉴 [鱼饵名]` | 查询使用该鱼饵的鱼（如：`/鱼群图鉴 嗡嗡石蝇`） |
| `/鱼群图鉴 [鱼的种类]` | 按种类查询（普通鱼/鱼王/鱼皇） |
| `/鱼群图鉴 [天气]` | 按天气查询限定鱼（如：`/鱼群图鉴 小雨`） |
| `/鱼群图鉴 [地区\|钓场] [页码]` | 按地区或钓场筛选，支持页码 |
| `/未获取 [地区\|钓场] [天气] [鱼饵] [页码]` | 查询未钓到的鱼（所有参数可选，每页10条） |
| `/钓鱼记录 [页码]` | 查看钓鱼历史记录 |
